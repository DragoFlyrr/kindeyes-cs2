...
IniRead, CoverageThreshold, %IniFile%, Settings, CoverageThreshold, 40
IniRead, SampleStep, %IniFile%, Settings, SampleStep, 500
IniRead, TargetExe, %IniFile%, Settings, TargetExe, cs2.exe
Enabled := true
